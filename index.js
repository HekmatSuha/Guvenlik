...
/* Encryption processing from .env file  */
uyeSemasi.plugin(encrypt, {
  secret: process.env.ANAHTAR,
  encryptedFields: ["sifre"],
});
...
/*    Controlling the Email & Pass Freom the Database    */
